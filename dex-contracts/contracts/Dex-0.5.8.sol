...
pragma solidity ^0.5.8; // <-- SWC-102: Outdated compiler version, SWC-103: Floating pragma
...
contract SimpleDex {
    ...
    function removeLiquidity(address tokenAddress, uint share) external {
    ...
    function delegateTo(address callee, bytes calldata data) external {
    ...
    function collisionExample(string memory a, uint b) public pure returns (bytes32) {
